...
create('http-probe', 'NetworkAccessPoint')
cd('/Servers/%s/NetworkAccessPoints/http-probe' % admin_server_name)
set('Protocol', 'http')
...
create('http-probe', 'NetworkAccessPoint')
cd('/ServerTemplates/%s/NetworkAccessPoints/http-probe' % templateName)
set('Protocol', 'http')
set('ListenAddress', domain_uid + '-' + managed_server_name_base + '${id}')
set('ListenPort', 8888)
set('HttpEnabledForThisProtocol', true)
set('TunnelingEnabled', false)
set('OutboundEnabled', false)
...
cd('/ServerTemplates/%s' % templateName)
create('istio-app', 'NetworkAccessPoint')
cd('/ServerTemplates/%s/NetworkAccessPoints/istio-app' % templateName)
set('ListenAddress', '127.0.0.1')
set('PublicAddress', domain_uid + '-' + managed_server_name_base + '${id}')
...
cd('/ServerTemplates/%s' % templateName)
create('http-app', 'NetworkAccessPoint')
cd('/ServerTemplates/%s/NetworkAccessPoints/http-app' % templateName)
set('ListenAddress', '127.0.0.1')
set('PublicAddress', domain_uid + '-' + managed_server_name_base + '${id}')
set('ListenPort', 31111)
set('TunnelingEnabled', false)
